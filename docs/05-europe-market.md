...
(vergleich.org, konsumentenecho.de). What follows is assembled from search
indexes of those same pages, so treat product-level detail as second-hand and
verify prices directly before quoting them anywhere.

## 1. The German price band

| Product | Price |
|---|---|
| Entry model | €7.99 |
| Hillfield Ölzerstäuber | €15.99 |
| CZDIDEXI | €16.60 |
...
**Valuxe Pro Series Elements 3.0 ships UV-protected glass.** Somebody in Europe
has identified the light-and-rancidity problem and solved it *without* giving up
transparency. This is the closest anything on the market comes to our opaque-body
argument, and it is a better answer than plain glass. Our counter-argument is
that UV glass still shatters and still lets visible light through, and that our
...
**This is a hole we created for ourselves.** Removing the level window means the
user cannot see the oil rising while they pour into a Ø48 mm opaque steel mouth.
The stroke counter tells you what is left *after* you fill; it tells you nothing
*during* the fill.

**Fix: a laser-etched fill line on the inside wall, at 250 ml.** It is visible
looking down the wide mouth, costs almost nothing, adds no leak path, and closes
a documented failure mode. Add a matched pour line to the decanter so one glug
from the decanter equals one sprayer fill.

Two further complaints worth catching in the test plan:
...
- https://www.vergleich.org/oelsprueher/
- https://reviews.konsumentenecho.de/product/%C3%B6lzerst%C3%A4uber/
- https://upkitchen.de/shop/easyspray/
- https://oel-radiator.de/oelsprueher-test-vergleich/
- https://www.yarramate.com/blogs/article/why-oil-sprayer-not-working
- https://www.asinsight.com/report/US/cooking-oil-sprayer
- https://www.amazon.com/Best-Sellers-Oil-Sprayers-Dispensers/zgbs/kitchen/289789
